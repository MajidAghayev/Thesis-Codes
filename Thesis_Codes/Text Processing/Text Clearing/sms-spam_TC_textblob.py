...
def clean_text_with_textblob(text):
    # Lowercase and tokenize text using TextBlob
    blob = TextBlob(text.lower())

    # Filter out non-alphabetic tokens and join back into a single string
...
# Apply text cleaning
data['cleaned_text'] = data['sms'].apply(clean_text_with_textblob)
...
print("\nCleaned Text Model Metrics (using TextBlob):")
