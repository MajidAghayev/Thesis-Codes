...
# Define tokenization function using NLTK
def tokenize_text_with_nltk(text):
...
data['tokenized_text'] = data['text'].apply(tokenize_text_with_nltk)
...
print("\nTokenized Text Model Metrics using NLTK:")
